...
<div align="center">
  <picture>
    <source srcset="./assets/zenvi-icon-dark.svg" media="(prefers-color-scheme: dark)">
    <source srcset="./assets/zenvi-icon-light.svg" media="(prefers-color-scheme: light)">
    <img src="./assets/zenvi-icon-dark.svg" alt="Zenvi Logo" width="100px">
  </picture>
</div>
#+end_html
